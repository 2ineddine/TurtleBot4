...
%%%
z = DoObservationModel(xTrue, iFeature,Map)+sqrt(PYTrue)*randn(1,1);
%z(2) = AngleWrap(z(2));
...
% -> qualite des estimations en baisse
% -> + si on ne mesure que la distance risque de mauvaise association...
